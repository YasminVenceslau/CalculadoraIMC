            ...
            <Cabecalho />
                ...
                <form onSubmit={(e) =>{
                    ...
                    <div className="imcVals">
                        <img src="./assets/imagens/IMC-val-18.5.png" alt="" />
                        <img src="./assets/imagens/IMC-val-18.6.png" alt="" />
                        <img src="./assets/imagens/IMC-val-25.png" alt="" />
                        <img src="./assets/imagens/IMC-val-30.png" alt="" />
                        <img src="./assets/imagens/IMC-val-35.png" alt="" />
                        <img src="./assets/imagens/IMC-val-40.png" alt="" />
                    </div>
                </form>
